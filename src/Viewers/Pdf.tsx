...
const Pdf: React.ForwardRefRenderFunction<ViewerRefProps, MdProps> = (props, ref) => {
  const { } = props
  ...
  return (
    ...
    >
      <p style={{ whiteSpace: 'pre' }}>{mdText}</p>
    </ReactModal>
  )
}

export default React.forwardRef<ViewerRefProps, MdProps>(Pdf)

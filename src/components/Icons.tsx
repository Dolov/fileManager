...
export interface IconsProps {
  name: 'folder' | 'excel' | 'word' | 'js' | 'ts' | 'jsx' | 'tsx' | 'gitignore' | 'markdown' | 'image' | 'left' | 'right' | 'zip' | 'css' | 'vue' | 'less' | 'html' | 'sass' | 'styl' | 'video' | 'audio' | 'text' | 'app' | 'setting' | 'java' | 'python' | 'font' | 'json' | 'loading'
  size?: number
  width?: number | string
